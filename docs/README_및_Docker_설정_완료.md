...
1. **`Dockerfile`**
   - Python 3.12 기반
   - 필수 시스템 패키지 자동 설치 (libsndfile1, ffmpeg)
   - 헬스 체크 포함
...
├── scripts/
│   └── docker_setup.sh       # 자동화 스크립트
└── README_개발자_가이드.md    # 종합 가이드
```
...
- `docs/Docker_설정_완료_요약.md`: Docker 설정 요약

### 기능별 문서
- `docs/ESP32_통합_이상_감지_시스템_가이드.md`
- `docs/데이터_수집_및_검증_시스템_가이드.md`
- `docs/Active_Learning_시스템_개선_가이드.md`
